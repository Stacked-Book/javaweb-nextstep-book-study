...
import static util.Url.INDEX_PAGE;
import static util.Url.LOGIN;
import static util.Url.LOGIN_FAILED_PAGE;
import static util.Url.LOGIN_PAGE;
import static util.Url.REGISTER;
import static util.Url.REGISTER_PAGE;
import static util.Url.USER_LIST;
...
public class V0RequestHandler extends Thread {
    ...
    public V0RequestHandler(Socket connection, UserService userService1) {
